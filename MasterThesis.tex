...
\subtitle{Sequential Decision Agents in Reinforcement Learning}


\documentType{Dissertation }
\major{Master of Science in Mathematics \& Statistics}
...
%    \addtotoc{Introduction}{\input{introduction.tex}}  % Generate the introduction
    \inputfile{introduction.tex}
    %\lettrine[lines=4,slope=1pt]{A}{ll} \blindtext \\
    %\lettrine[lines=3,slope=1pt]{\textcolor{red}{A}}{n} \blindtext
    \inputfile{sec1.tex}
    \inputfile{sec2.tex}
    %\inputfile{sec3.tex}
    %\inputfile{sec4.tex}
